...
def main():
    ...
    parser.add_argument('--format', help='レポート形式 (md, html, xml, csv, all)', default='md')
    ...
    try:
        ...
        if args.format.lower() == 'all':
            tester.generate_all_reports(args.output)
        elif args.format.lower() == 'html':
            tester.generate_html_report(args.output.replace('.md', '.html'))
        elif args.format.lower() == 'xml':
            tester.generate_junit_report(args.output.replace('.md', '.xml'))
        elif args.format.lower() == 'csv':
            tester.generate_csv_report(args.output.replace('.md', '.csv'))
        else:  # デフォルトはMarkdown
